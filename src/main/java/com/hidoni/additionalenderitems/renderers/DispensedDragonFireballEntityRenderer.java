...
public class DispensedDragonFireballEntityRenderer extends EntityRenderer<DispensedDragonFireballEntity>
{
    ...
    public DispensedDragonFireballEntityRenderer(EntityRendererManager renderManager)
    {
        super(renderManager);
    }
    ...
    @Override
    public void render(DispensedDragonFireballEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
    {
        matrixStackIn.push();
    ...
    @Override
    public ResourceLocation getEntityTexture(DispensedDragonFireballEntity entity)
    {
