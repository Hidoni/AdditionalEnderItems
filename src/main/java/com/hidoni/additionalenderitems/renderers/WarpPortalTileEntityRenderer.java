...
public class WarpPortalTileEntityRenderer extends TileEntityRenderer<WarpPortalTileEntity>
{
    ...
    public WarpPortalTileEntityRenderer(TileEntityRendererDispatcher rendererDispatcherIn)
    {
        super(rendererDispatcherIn);
    }

    @Override
    public void render(WarpPortalTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn)
    {
    ...
    private void renderCube(WarpPortalTileEntity tileEntityIn, float p_228883_2_, float p_228883_3_, Matrix4f p_228883_4_, IVertexBuilder p_228883_5_)
    {
