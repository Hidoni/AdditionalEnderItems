...
public class ModItems
{
    ...
    public static final RegistryObject<Item> CUSTOMIZABLE_ELYTRA = Registration.ITEMS.register("customizable_elytra", () -> new CustomizableElytraItem((new Item.Properties()).maxDamage(432).group(ModItemGroup.ADDITIONAL_ENDER_ITEMS_GROUP).rarity(Rarity.UNCOMMON)));
