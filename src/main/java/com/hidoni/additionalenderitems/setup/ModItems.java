...
public class ModItems
{
    ...
    public static final RegistryObject<Item> DRAGON_CHARGE = Registration.ITEMS.register("dragon_charge", () -> new DragonChargeItem(new Item.Properties().group(ModItemGroup.ADDITIONAL_ENDER_ITEMS_GROUP)));
