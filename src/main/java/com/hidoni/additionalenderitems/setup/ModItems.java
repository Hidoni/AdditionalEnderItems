...
public class ModItems
{
    ...
    public static final RegistryObject<Item> DYEABLE_ELYTRA = Registration.ITEMS.register("dyeable_elytra", () -> new DyeableElytraItem((new Item.Properties()).maxDamage(432).group(ModItemGroup.ADDITIONAL_ENDER_ITEMS_GROUP).rarity(Rarity.UNCOMMON)));
